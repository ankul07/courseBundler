...
export const createSubscription = catchAsyncError(async (req, res, next) => {
  ...
  const plan_id = process.env.PLAIN_ID || "plan_MM5J68dukKrhpy";
...
export const cancelSubscription = catchAsyncError(async (req, res, next) => {
  ...
  res.status(200).json({
    success: true,
    message: refund
      ? "subscription cancel you will receive full refund with in 7 days"
      : "no refund initiate as subscriptiuon was cancelled after 7 days",
  });
});
